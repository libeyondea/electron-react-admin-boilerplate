...
const AuthComponent = lazy(() => import('renderer/modules/auth/components'));
const MainComponent = lazy(() => import('renderer/modules/main/components'));
const SplashComponent = lazy(() => import('renderer/modules/splash/components'));
