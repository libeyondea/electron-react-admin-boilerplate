...
import { getPageNumbers, getTotalPages } from 'renderer/helpers/pagination';
      ...
      <div className="sm:flex-1 flex flex-col md:flex-row md:items-center md:justify-between">
        <div className="flex items-center mb-4 md:mb-0 mr-0 md:mr-4">
          <p className="text-sm text-gray-700">
            Showing{' '}
            <span className="font-medium">{limit * page - limit + 1}</span> to{' '}
        ...
        <div className="flex items-center">
          <nav
            className="relative inline-flex flex-wrap rounded-md -space-x-px"
            ...
            {page !== 1 ? (
              <Fragment>
                ...
                <button
                  ...
                  onClick={(event) =>
                    _onChangePage(event, page === 1 ? 1 : page - 1)
                  }
                >
