...
import { CreateUser, ListUser, UpdateUser, User } from 'renderer/types/user';
import { ResponseData, ResponseDataPagination } from 'renderer/types/response';
import { AxiosResponse } from 'axios';

const userService = {
  list: (
    params?: ListUser
  ): Promise<AxiosResponse<ResponseDataPagination<User[]>>> => {
